    ...
    return (
        <div className={`${showFilterPhone ? "max-sm:fixed" : "max-sm:hidden"} max-sm:inset-0 z-100 max-sm:h-screen max-sm:overflow-scroll bg-white rounded-lg shadow-sm border border-gray-200 h-fit sticky top-24 md:min-w-[300px]`}>
            ...
            <div className='p-4 space-y-6 sm:max-h-[calc(100vh-200px)] overflow-y-scroll no-scrollbar'>
                ...
                {/* platform filter */}
                <div >
                    <button onClick={() => toggleSelection("platform")} className='flex items-center justify-between w-full mb-3'>
                ...
                {/* Price filter */}
                <div >
                    <button onClick={() => toggleSelection("price")} className='flex items-center justify-between w-full mb-3'>
                    ...
                    {expandedSections.price && (
                        <div className='space-y-3'>
                            <input type="range" min="0" max="1000000" step="1000" value={filters.maxPrice || 1000000} onChange={(e) => onFiltersChange({ ...filters, maxPrice: parseInt(e.target.value) })} className='w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer accent-indigo-600' />
                ...
                {/* Followers Range */}
                <div >
                    <button onClick={() => toggleSelection("followers")} className='flex items-center justify-between w-full mb-3'>
                ...
                {/* Niche filter */}
                <div >
                    <button onClick={() => toggleSelection("niche")} className='flex items-center justify-between w-full mb-3'>
                ...
                <div >
                    <button onClick={() => toggleSelection("status")} className='flex items-center justify-between w-full mb-3'>
