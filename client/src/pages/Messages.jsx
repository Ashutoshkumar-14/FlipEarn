    ...
    <div className='mx-auto min-h-screen px-6 md:px-16 lg:px-24 xl:px-32'>
      <div className='py-10'>
        ...
        <div className='relative max-w-xl mb-8'>
          ...
          <input type="text" placeholder='Search conversions...' value={searchQuery} onChange={(e)=>setSearchQuery(e.target.value)}
           className='pl-10 pr-4 py-2 w-full border border-gray-300 rounded-lg focus:outline-indigo-500' />
        </div>
        ...
        {loading ? (
          ...
          <h3 className='text-xl font-medium text-gray-800 mb-2'>{searchQuery ? "No messages found for this search." : "You have no messages yet."}</h3>
          <p className='text-gray-600'>
            {searchQuery ? "Try a different search term" : 'Start a conversion by viewing a listings and clicking "Chat with Seller"'}
          </p>
          </div>
        ) : (
