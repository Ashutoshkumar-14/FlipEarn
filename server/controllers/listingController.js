...
//Controllers for Adding listing to database
export const addListing = async (req, res) => {
    try {
        ...
        if (req.plan !== "premium") {
            ...
            if (listingCount >= 5) {
                return res.status(400).json({ message: "You have reached the free listing plan" });
            }
        }
        ...
        // wait for all uploads to commplete
        ...
        return res.status(201).json({ message: "Account Listed successfilly", listing });
    } catch (error) {
        console.log(error)
...
//controllers for getting all public listing
...
//controllers for updating listing in database
...
export const markFeatured = async (req, res) => {
    try {
        ...
        // Unset all other featurd listings
